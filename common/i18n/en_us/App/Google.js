module.exports = {
  "tipssafe": {
    ...
    "tipsafegl": "To use Google verification password, you need to download the \"Google Authenticator\" application, scan the QR code under \"Google Authenticator\", or manually add an account and enter the QR code using the following 16-character key. Enter your account login password and 6 digits in the Google Authenticator and click OK.",
    "tipsfw": "Protected Area",
    "tipmy16": "16-character key:",
    ...
    "tipsmy16save": "Please write down and save your 16-character key in a safe place.",
    "tipssendpostgl": "After Google verification is enabled, Google verification is required for every withdrawal request. After the verification is correct, a request for a withdrawal can be successfully sent.",
    "tipsglUntie": "You are currently unbinding the Google Validator",
    "tipsglUntiedes": "After unbinding, you will not enjoy the two-factor protection service for withdrawal, API protection, and login module login. If you want to close the two-factor verification password, enter your login password and 6-digit double verification password below, then click the \"Deactivate 2FA\" button. Please be careful."
  },
  "GLD": {
    "email": "Email",
